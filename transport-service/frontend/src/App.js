    ...
    <div className="App">
      <header className="header">
        <div className="container">
          <h1>Transport Service - Carrier Portal</h1>
          ...
          <nav className="nav">
            ...
            <button
              className={currentPage === 'transports' ? 'active' : ''}
              onClick={() => setCurrentPage('transports')}
            >
              My Transports
            </button>
          </nav>
      ...
      <main className="container">
        ...
        {currentPage === 'transports' && (
          <TransportListPage currentUser={currentUser} />
        )}
      </main>
    </div>
  );
